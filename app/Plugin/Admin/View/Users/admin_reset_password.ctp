...
<div class="form-group <?php echo $this->Form->isFieldError('password') ? 'has-error' : '' ?>">
  <label class="col-sm-2 control-label"><?php echo __d('admin', 'Mật khẩu:'); ?></label>
  <div class="col-sm-10">
    <?php 
...
<div class="form-group <?php echo $this->Form->isFieldError('password_again') ? 'has-error' : '' ?>">
  <label class="col-sm-2 control-label"><?php echo __d('admin', 'Nhập lại mật khẩu:'); ?></label>
  <div class="col-sm-10">
    <?php 
...
<div class="form-group">
  <div class="col-sm-offset-2 col-sm-10">
     <?php echo $this->Form->end(array('label' => __d('admin', 'Lưu'), 'class' => 'btn btn-primary')); ?>
  </div>
</div>
</div>	